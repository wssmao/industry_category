...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (87, '0519', '其他农业专业及辅助性活动', '051', 3, '指代耕代种代收、大田托管等其他农业活动');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (88, '052', '林业专业及辅助性活动', '05', 2, '指为林业生产提供的林业有害生物防治、林地防火等各种辅助性活动');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (89, '0521', '林业有害生物防治服务', '052', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (90, '0522', '森林防火活动', '052', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (91, '0523', '林产品初级加工活动', '052', 3, '指对各种林产品进行去皮、打枝或去料、净化、初包装提供至贮木场或初级加工活动');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (92, '0529', '其他林业专业及辅助性活动', '052', 3, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (189, '1363', '鱼油提取及制品制造', '136', 3, '指从鱼或鱼肝中提取油脂，并生产制品的活动');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (286, '178', '产业用纺织制成品制造', '17', 2, '也称产业用纺织制成品制造（包括帐篷等户外及庭院休闲用品制造）');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (291, '1789', '其他产业用纺织制成品制造', '178', 3, '指革基布，过滤、防护用纺织品，工业用毡、呢，建筑用纺织品，交通运输用纺织品，包装用纺织品，文体用纺织品，绝缘隔热纺织品，农业用纺织品，渔业用纺织品，造纸用纺织品等其他产业用纺织制成品的生产活动');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (333, '203', '木质制品制造', '20', 2, '指以木材为原料加工成建筑用木料和木材组件、木容器、软木制品及其他木制品的生产活动，但不包括木质家具的制造');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (388, '243', '工艺美术及礼仪用品制造', '24', 2, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (523, '2928', '人造草坪制造', '292', 3, '指采用合成纤维，植入在机织的基布上，并具有天然草运动性能的人造草制造');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (524, '2929', '塑料零件及其他塑料制品制造', '292', 3, '指塑料制绝缘零件、密封制品、紧固件，以及汽车、家具等专用零配件的制造，以及上述未列明的其他各类非日用塑料制品的生产活动');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (684, '346', '烘炉、风机、包装等设备制造', '34', 2, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (767, '359', '环保、邮政、社会公共服务及其他专用设备制造', '35', 2, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1058, '4899', '其他土木工程建筑施工', '489', 3, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1081, '511', '农、林、牧、渔产品批发', '51', 2, '指未经过加工的农作物、林产品及牲畜、畜产品、鱼苗的批发和进出口活动，但不包括蔬菜、水果、肉、禽、蛋、奶及水产品的批发和进出口活动，包括以批发为目的的农副产品收购活动');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1084, '5113', '畜牧渔业饲料批发', '511', 3, '不包括宠物');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1115, '5145', '音像制品、电子和数字出版物批发', '514', 3, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1136, '5172', '汽车及零配件批发', '517', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1137, '5173', '摩托车及零配件批发', '517', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1138, '5174', '五金产品批发', '517', 3, '指小五金、工具、水暖部件及材料的批发和进出口活动，不包括自行车及零配件的批发和进出口');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1139, '5175', '电气设备批发', '517', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1140, '5176', '计算机、软件及辅助设备批发', '517', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1141, '5177', '通讯设备批发', '517', 3, '指电信设备的批发和进出口活动');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1142, '5178', '广播影视设备批发', '517', 3, '指广播影视设备的批发和进出口活动');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1146, '5182', '一般物品拍卖', '518', 3, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1175, '5235', '厨具卫具及日用杂品零售', '523', 3, '指专门经营炊具、厨具、餐具、日用陶瓷、日用玻璃器皿、塑料器皿、清洁用具和用品的店铺零售活动，以及各种材质其他日用杂品的零售活动');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1176, '5236', '钟表、眼镜零售', '523', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1177, '5237', '箱包零售', '523', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1178, '5238', '自行车等代步设备零售', '523', 3, '包括自行车、助动自行车（包括电力助动自行车和燃油助动自行车）以及平衡车、老年代步车、三轮车等汽车、摩托车以外的代步车及零配件零售');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1196, '526', '汽车、摩托车、零配件和燃料及其他动力销售', '52', 2, '指专门经营汽车、摩托车、汽车部件、汽车零配件及燃料、燃气的零售活动以及汽车充电桩服务');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1206, '5272', '日用家电零售', '527', 3, '指专门经营冰箱、洗衣机、空调、吸尘器及其他家用电器设备的店铺零售活动');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1220, '5291', '流动货摊零售', '529', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1221, '5292', '互联网零售', '529', 3, '指零售商通过电子商务平台开展销售的活动，不包括仅提供网络支付的活动，以及仅建立或提供网络交易平台和接入的活动');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1222, '5293', '邮购及电视、电话零售', '529', 3, '指通过寄递及电视、电话等方式进行销售，并送货上门的零售活动');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1223, '5294', '自动售货机零售', '529', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1224, '5295', '旧货零售', '529', 3, '指从事生活用煤、煤油、酒精、薪柴、木炭以及罐装液化石油气等专门零售活动');

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1225, '5296', '生活用燃料零售', '529', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1226, '5297', '宠物食品用品零售', '529', 3, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1508, '711', '机械设备经营租赁', '71', 2, '指不配备操作人员的机械设备的租赁服务');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1512, '7114', '计算机及通讯设备经营租赁', '711', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1513, '7115', '医疗设备经营租赁', '711', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1514, '7119', '其他机械与设备经营租赁', '711', 3, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1515, '712', '文体设备和用品出租', '71', 2, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1516, '7121', '休闲娱乐用品设备出租', '712', 3, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1521, '7129', '其他文体设备和用品出租', '712', 3, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1525, '721', '组织管理服务', '72', 2, '指市场化组织管理和经营性组织管理');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1531, '7219', '其他组织管理服务', '721', 3, '指其他各类企业、行业管理机构和未列明的综合跨界管理的活动');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1620, '748', '工程技术与设计服务', '74', 2, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1789, '842', '基层医疗卫生服务', '84', 2, null);
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1860, '887', '群众文体活动', '88', 2, null);

insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1861, '8870', '群众文体活动', '887', 3, '指对各种主要由城乡群众参与的文艺类演出、比赛、展览、文艺知识鉴赏等公益性文化活动的管理活动，以及群众参与的各级各类体育竞赛和活动');
...
insert into industry_category (ID, INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values (1917, '929', '其他国家机构', '92', 2, '指其他未另列明的国家机构的活动');
...
values ('367', '汽车零部件及配件制造', '36', 2, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('3670', '汽车零部件及配件制造', '367', 3, '指机动车辆及其车身的各种零配件的制造');

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('84', '卫生', 'Q', 1, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('9291', '消防管理机构', '929', 3, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('9292', '其他未列明国家机构', '929', 3, null);


insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('0179', '其他中药材种植', '017', 3, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('0391', '兔的饲养', '039', 3, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('0392', '蜜蜂饲养', '039', 3, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('0399', '其他未列明畜牧业', '039', 3, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('278', '药用辅料及包装材料', '27', 2, '指药品用辅料和包装材料等制造');

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('2780', '药用辅料及包装材料', '278', 3, '指药品用辅料和包装材料等制造');

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('283', '生物基材料制造', '28', 2, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('2831', '生物基化学纤维制造', '283', 3, '指以生物单体或天然有机高分子为原料生产纤维的活动，除天然动植物纤维外，特指生物基再生纤维、生物基合成纤维等');

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('2832', '生物基、淀粉基新材料制造', '283', 3, '指使用可再生生物资源（如玉米、木薯、秸秆等）经过糖化、发酵、聚合等步骤制成的聚乳酸等生物基、淀粉基材料的活动');


insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('829', '其他未列明服务业', '82', 2, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('8290', '其他未列明服务业', '829', 3, null);

insert into industry_category (INDUSTRY_ID, NAME, PARENT_ID, LEVEL_TYPE, DESCRIPTION)
values ('932', '民主党派', '93', 2, null);
